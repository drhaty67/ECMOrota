...
2. Open **SQL Editor**, run `supabase/schema.sql`, then `supabase/integration_v2.sql`, `supabase/bank_holidays_v3.sql`, and `supabase/flexible_fallback_v4.sql` in that order.
